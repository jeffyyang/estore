...
class WxPayConf_pub
{
    ...
    const APPID = 'wxba08a98647000606';
    //受理商ID，身份标识
    const MCHID = '10027271';
    //商户支付密钥Key。审核通过后，在微信发送的邮件中查看
    const KEY = '123456789012345678901234567890wx';

    //JSAPI接口中获取openid，审核后在公众平台开启开发模式后可查看
    const APPSECRET = '5a75902adcedc48fdd9d472152bdb841';
    
    //=======【JSAPI路径设置】===================================
    //获取access_token过程中的跳转uri，通过跳转将code传入jsapi支付页面
    const JS_API_CALL_URL = 'http://www.zlgame.com/demo/js_api_call.php';
    
    //=======【证书路径设置】=====================================
    //证书路径,注意应该填写绝对路径
    const SSLCERT_PATH    = 'E:/servers/xampp/htdocs/wxpay/WxPayPubHelper/cacert/apiclient_cert.pem';
    const SSLKEY_PATH     = 'E:/servers/xampp/htdocs/wxpay/WxPayPubHelper/cacert/apiclient_key.pem';
    const SSLCART_PATH    = 'E:/servers/xampp/htdocs/wxpay/WxPayPubHelper/cacert/rootca.pem';

    //=======【异步通知url设置】===================================
    //异步通知url，商户根据实际开发过程设定
    const NOTIFY_URL = 'http://www.zlgame.cn/demo/notify_url.php';
...
class Common_util_pub
{
    ...
    {       
        ...
        $ch = curl_init();
        //设置超时
        // JeffyYang curl_setopt($ch, CURLOP_TIMEOUT, $second);
        //这里设置代理，如果有的话
    ...
    function postXmlSSLCurl($xml,$url,$second=30)
    {
        ...
        //Jeffy Yang 默认格式为PEM，可以注释
        curl_setopt($ch,CURLOPT_SSLKEYTYPE,'PEM');
        curl_setopt($ch,CURLOPT_CAINFO, WxPayConf_pub::SSLCART_PATH);
