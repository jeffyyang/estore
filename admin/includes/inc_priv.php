...
//微信平台管理
    ...
    $purview['02_wx_menu']              = 'wx_manage';
    $purview['03_wx_keyword']           = 'wx_manage';
    $purview['04_wx_event']             = 'wx_manage';
    $purview['05_wx_media']             = 'wx_manage';
    $purview['05_wx_article']           = 'wx_manage';
    $purview['06_wx_msg_send']          = 'wx_manage';
    $purview['07_wx_msg_send_history']  = 'wx_manage'; 
