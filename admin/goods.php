...
elseif ($_REQUEST['act'] == 'add' || $_REQUEST['act'] == 'edit' || $_REQUEST['act'] == 'copy')
{
    ...
    else
    {
        ...
        $goods['use_start_date'] = local_date('Y-m-d', $goods['use_start_date']);
        $goods['use_end_date'] = local_date('Y-m-d', $goods['use_end_date']);
...
elseif ($_REQUEST['act'] == 'insert' || $_REQUEST['act'] == 'update')
{
    ...
    $is_promote = empty($promote_price) ? 1 : 0;
    $promote_start_date = (!empty($_POST['promote_start_date'])) ? local_strtotime($_POST['promote_start_date']) : 0;
    $promote_end_date = (!empty($_POST['promote_end_date'])) ? local_strtotime($_POST['promote_end_date']) : 0;

    $use_start_date = (!empty($_POST['use_start_date'])) ? local_strtotime($_POST['use_start_date']) : 0;
    $use_end_date = (!empty($_POST['use_end_date'])) ? local_strtotime($_POST['use_end_date']) : 0;
