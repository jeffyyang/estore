...
<table cellspacing="1" cellpadding="3" width="100%">
  ...
  <tr>
    ...
    <td><input type="file" name="shop_logo" id="logo" size="45"><?php if ($this->_var['shop']['shop_logo'] != ""): ?><input type="button" value="<?php echo $this->_var['lang']['drop_shop_logo']; ?>" onclick="if (confirm('<?php echo $this->_var['lang']['confirm_drop_logo']; ?>'))location.href='shops.php?act=drop_logo&id=<?php echo $this->_var['shop']['shop_id']; ?>'"><?php endif; ?>
    ...
    <td><input type="file" name="lic_img" id="img_lic" size="45"><?php if ($this->_var['shop']['shop_logo'] != ""): ?><input type="button" value="<?php echo $this->_var['lang']['drop_lic_img']; ?>" onclick="if (confirm('<?php echo $this->_var['lang']['confirm_drop_licimg']; ?>'))location.href='shops.php?act=drop_licimg&id=<?php echo $this->_var['shop']['shop_id']; ?>'"><?php endif; ?>
  ...
  <tr>
    ...
    <td><input type="file" name="id_img" id="img_id" size="45"><?php if ($this->_var['shop']['shop_logo'] != ""): ?><input type="button" value="<?php echo $this->_var['lang']['drop_id_img']; ?>" onclick="if (confirm('<?php echo $this->_var['lang']['confirm_drop_idimg']; ?>'))location.href='shops.php?act=drop_idimg&id=<?php echo $this->_var['shop']['shop_id']; ?>'"><?php endif; ?>
