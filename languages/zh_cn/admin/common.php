...
/*商户管理*/
$_LANG['shopcate_list'] = '商户分类';
$_LANG['shopcate_add'] = '添加商户分类';
$_LANG['shop_list'] = '商户列表';
$_LANG['shop_add'] = '添加商户';
...
/* 订单管理 */
$_LANG['02_group_order_list'] = '团购订单列表';
$_LANG['02_integral_order_list'] = '积分商城订单';
...
$_LANG['11_refund_list'] = '退款处理';
$_LANG['12_complaints_list'] = '维权处理';
...
/* 微信平台管理 */
$_LANG['02_wx_menu'] = '定制菜单管理';
$_LANG['03_wx_keyword'] = '关键字回复';
$_LANG['04_wx_event'] = '事件定义';
$_LANG['05_wx_media'] = '媒体库管理';
$_LANG['051_wx_news'] = '图文管理';
$_LANG['06_wx_msg_send'] = '信息群发';
$_LANG['07_wx_msg_send_history'] = '群发记录';

$_LANG['02_wx_menu_list'] = '微信菜单';
$_LANG['02_wx_menu_add']  = '添加微信菜单';

$_LANG['03_wx_keyword_list'] = '微信关键字';
$_LANG['03_wx_keyword_add']  = '添加微信关键字';

$_LANG['04_wx_event_list'] = '微信事件';
$_LANG['04_wx_event_add']  = '添加微信事件';

$_LANG['05_wx_media_list'] = '媒体库管理';
$_LANG['05_wx_media_add']  = '添加媒体资源';

$_LANG['051_wx_news_list'] = '图文资源管理';
$_LANG['051_wx_news_add']  = '添加图文资源';
