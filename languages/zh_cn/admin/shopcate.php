...
$_LANG['notice_style'] = '您可以为每一个商户分类指定一个样式表文件。例如文件存放在 themes 目录下则输入：themes/style.css';
...
$_LANG['catadd_succed'] = '新商户分类添加成功!';
$_LANG['catedit_succed'] = '商户分类编辑成功!';
$_LANG['catdrop_succed'] = '商户分类删除成功!';
$_LANG['catremove_succed'] = '商户分类转移成功!';
$_LANG['move_cat_success'] = '转移商户分类已成功完成!';

$_LANG['cat_move_desc'] = '什么是转移商户分类?';
