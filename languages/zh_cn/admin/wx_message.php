...
/* 发送微信消息 */
$_LANG['openids'] = '用户标识(openId)';
$_LANG['user_group'] = '按用户分组发送';
$_LANG['openids_notice'] = '多个用户用半角逗号分开';
$_LANG['msg_type'] = '消息类型';
$_LANG['msg_type_txt']     = '文本';
$_LANG['msg_type_image']   = '图片';
$_LANG['msg_type_voice']   = '声音';
$_LANG['msg_type_video']   = '视频';
$_LANG['msg_type_article'] = '图文';
$_LANG['msg'] = '消息内容';
$_LANG['msg_notice'] = '最长70字符';
$_LANG['send_date'] = '定时发送时间';

$_LANG['media_id'] = '媒体标识';
$_LANG['select_media'] = '请选择多媒体资料';
...
$_LANG['status'][0] = '失败';
$_LANG['status'][1] = '成功';
$_LANG['user_list'] = '全部粉丝';
$_LANG['please_select'] = '请选择分组';
...
$_LANG['js_languages']['send_empty_error'] = '消息内容不能为空！';
//--发送
